...
namespace Garnet.server
{
    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
        ...
        {
            // Per RESP3 specifications and observed behaviour, every failure in validation or authentication
            // should prevent the entire command from being run. For example,
            ...
            // First, validations, then authentication, and then if everything is fine,
            // the changes themselves.
            if ((respProtocolVersion != null) && (respProtocolVersion.Value != this.respProtocolVersion) &&
